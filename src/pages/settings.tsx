...
const Settings: NextPage = () => {
  ...
  const [image, setImage] = useState(sessionData?.user?.image || "");

  const modifyUserMutation = api.user.modifyUser.useMutation({
    onSuccess: async () => {
      // Reload the page
      router.reload();
    },
        ...
        <main className="lg:pr-96">
          ...
          <div className="divide-y divide-white/5">
            <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
              ...
              <form className="md:col-span-2" onSubmit={handleModifyUser}>
                  ...
                  <div className="col-span-full">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        id="name"
                        autoComplete="name"
                        value={sessionData?.user?.name || "Unknown"}
                        className="block w-full rounded-md border-0 bg-white/5 px-3 py-1.5 text-gray-400 shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
                        disabled={true}
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-span-full">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        name="avatar"
                        id="avatar"
                        defaultValue={sessionData?.user?.image || "Unknown"}
            ...
            {/* <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
              <div>
                <h2 className="text-white">Log out other sessions</h2>
                <p className="mt-1 text-sm leading-6 text-gray-400">
